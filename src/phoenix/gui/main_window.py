...
from phoenix.gui.controllers.debloat_controller import DebloatController
from phoenix.gui.controllers.inventory_controller import InventoryController
from phoenix.gui.dialogs.confirmation_dialog import ConfirmationDialog
from phoenix.gui.dialogs.progress_dialog import ProgressDialog
...
from phoenix.gui.result_dialog import ResultDialog
...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.doctor.refresh_button.clicked.connect(self.refresh_device)
        self.doctor.optimize_button.clicked.connect(self.quick_optimize)
        self.dashboard.refresh_button.clicked.connect(self.refresh_device)
    ...
    def connect_navigation(self):
        ...
        self.debloat.preview_button.clicked.connect(self.preview_debloat)
        self.debloat.execute_button.clicked.connect(self.execute_debloat)
        self.restore.restore_button.clicked.connect(self.restore_transaction)
    ...
    def refresh_device(self):
        ...
        try:
            ...
            self.doctor.update_device_info(report)
            self.doctor.optimize_button.setEnabled(True)
            ...
            logger.exception("Unable to refresh connected device state")
    ...
    def _show_disconnected_state(self):
        ...
        self.doctor.optimize_button.setEnabled(False)
    ...
    def _execute_apps(self, apps, title):
        ...
        for item in results:
            ...
            lines.append(f"[{status}] {item.package}")
    ...
    def execute_debloat(self):
        ...
        apps = self.debloat.selected_apps()
        self._execute_apps(apps, "Debloat Result")
    ...
    def restore_transaction(self):
        ...
        if not ConfirmationDialog.confirm(self, backup.results):
            return
    ...
    def quick_optimize(self):
        ...
        self._execute_apps(recommended, "Quick Optimize")
